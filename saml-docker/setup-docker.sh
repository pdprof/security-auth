...
#sed -i s/localhost:8080/idp-route-default.apps-crc.testing:8080/g resources/security/idpMetadata.xml
...
#sed -i s/localhost:9443/saml-route-default.apps-crc.testing:9443/g spMetadata.xml
